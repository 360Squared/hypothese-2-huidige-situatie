...
class CandidateWithJobTableViewController: UITableViewController {
    ...
    let canditateWithJob = [["Jan Jansen", "Vakken vuller"], ["Henk de Wit", "Spiegelaar"], ["Klaas Janssen", "Industrieel Lasser"]]
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = canditateWithJob[indexPath.row][0]
        cell.detailTextLabel?.text = canditateWithJob[indexPath.row][1]
        // Configure the cell...
